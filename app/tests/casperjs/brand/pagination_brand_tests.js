var url = "http://localhost:3000/brastemp?ts=4";
//var teste;

casper.test.begin('Phantomjs Tests >> Search pagination by brand', 11, function(test) {
    ...
    casper.start(url, function() {
        ...
        test.assertTitle("Brastemp é no Decidaki - veja avaliações antes de decidir comprar!");
      ...
      // previous    
      test.assertElementCount('#a_previous', 0git); 
