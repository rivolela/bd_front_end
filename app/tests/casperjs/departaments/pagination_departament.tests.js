var url = "http://localhost:3000/eletrodomésticos?ts=3";
//var teste;

casper.test.begin('Phantomjs Tests >> Search pagination by departaments', 11, function(test) {
    ...
    casper.start(url, function() {
        ...
        test.assertTitle("Eletrodomésticos é no Decidaki - veja avaliações antes de decidir comprar!");
