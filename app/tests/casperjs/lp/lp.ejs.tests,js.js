...
casper.test.begin('Phantomjs Tests >> Landing Page ( without cookie )', 5, function(test) {
    ...
    casper.start(url, function() {
      ...
      test.assertElementCount('#href_bd_boy_happy', 0,"offers search for casperjs retrieves 20 href_bd_boy_happy selectors");
      test.assertElementCount('#href_bd_boy_sad', 0,"offers search for casperjs retrieves 20 href_bd_boy_sad selectors");
