...
var url = "http://www.decidaki.com.br/geladeira?ts=2";
//var teste;
...
casper.test.begin('Phantomjs Tests >> Offers_orders_reviews ', 14, function(test) {
    ...
    casper.start(url, function() {
        ...
        test.assertTitle("Geladeira é no Decidaki - veja avaliações antes de decidir comprar!", "Decidaki title is the one expected");
        ...
        casper.wait(5000, function() {
            test.assertElementCount('#txt_ver_avaliacoes', 40,"it should find 10 #txt_ver_avaliacoes elements");
            test.assertElementCount('.bd_boy_happy', 40,"it should find 20 .bd_boy_happy elements");
            test.assertElementCount('.bd_boy_sad', 40,"it should find 20 .bd_boy_sad elements");
        });
        ...
        casper.wait(5000, function() {
            ...
            test.assertElementCount('#txt_ver_avaliacoes', 40,"it should find 20 #txt_ver_avaliacoes elements");
            test.assertElementCount('.bd_boy_happy', 40,"it should find 20 .bd_boy_happy elements");
            test.assertElementCount('.bd_boy_sad_off',0,"it should find 0 .bd_boy_sad_off elements");
        });
        ...
        casper.wait(5000, function() {
            ...
            test.assertElementCount('#txt_ver_avaliacoes', 40,"it should find 0 #txt_ver_avaliacoes elements");
            test.assertElementCount('.bd_boy_happy_off', 0,"it should find 0 .bd_boy_happy_off elements");
            test.assertElementCount('.bd_boy_sad', 40,"it should find 20 .bd_boy_sad elements");
        });
