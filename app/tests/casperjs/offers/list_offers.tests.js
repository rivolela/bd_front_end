...
casper.test.begin('Phantomjs Tests >> Offers_orders_reviews ', 14, function(test) {
    ...
    casper.start(url, function() {
        ...
        casper.wait(5000, function() {
            ...
            test.assertElementCount('#txt_ver_avaliacoes', 0,"it should find 20 #txt_ver_avaliacoes elements");
            test.assertElementCount('.bd_boy_happy', 20,"it should find 20 .bd_boy_happy elements");
            test.assertElementCount('.bd_boy_sad_off',20,"it should find 20 .bd_boy_sad_off elements");
        });
        ...
        casper.wait(5000, function() {
            ...
            test.assertElementCount('#txt_ver_avaliacoes', 0,"it should find 0 #txt_ver_avaliacoes elements");
            test.assertElementCount('.bd_boy_happy_off', 20,"it should find 20 .bd_boy_happy_off elements");
            test.assertElementCount('.bd_boy_sad', 20,"it should find 20 .bd_boy_sad elements");
        });
